exec 2>/dev/null
echo "downloading H3K4me3 ChIP-seq fastq files"
wget -q -P tmp/ https://sra-pub-run-odp.s3.amazonaws.com/sra/SRR23410270/SRR23410270
fasterq-dump -e 16 -O tmp/ tmp/SRR23410270
rm tmp/SRR23410270
pigz -p 16 tmp/*.fastq

echo "mapping and parsing ChIP-seq data"
bwa mem -SP5M -t 16 tmp/hg19/male.hg19.fa tmp/SRR23410270_1.fastq.gz tmp/SRR23410270_2.fastq.gz | pigz -p 16 > tmp/ChIP_H3K4me3.sam.gz
rm tmp/*.fastq.gz
pairtools parse --cmd-in 'pigz -d -p 16' --cmd-out 'pigz -p 16' -c tmp/hg19/hg19.chrom.sizes --output-stats ChIPseq_output/mapping_stats/stats_map_ChIPseq.txt -o tmp/ChIP_H3K4me3.pairsam.gz tmp/ChIP_H3K4me3.sam.gz
...
echo "generating H3K4me3 ChIP-seq profiles"
...
echo "calculating read coverage in DHSs for MChIP-C mononucleosomal data and ChIP-seq data"
